...
import { NavItemLink } from "../primitive/NavItem";

function Header({ children }: { children?: React.ReactNode | null }) {
    return (
        <div className="w-full min-h-16 h-fit bg-secondary flex flex-col justify-center items-center py-4">
            <div className="flex justify-center items-center ">
                <nav className="flex justify-between items-center">
                    <ul className="flex justify-center items-center gap-4">
                        ...
                        <li>
                            <NavItemLink to="/game" title="Game">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="16"
                                    height="16"
